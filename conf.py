...
BLOG_AUTHOR = "An Engineer"  # (translatable)
BLOG_TITLE = "An Engineer's Life for Me!"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://engineerslifeforme.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "creativerigor@gmail.com"
BLOG_DESCRIPTION = "Capturing My Engineering Process"  # (translatable)
...
# Following instructions here: http://www.jaakkoluttinen.fi/blog/how-to-blog-with-jupyter-ipython-notebook-and-nikola/
...
<span class="fa-stack fa-2x">
  <a href="https://github.com/engineerslifeforme">
    <i class="fa fa-circle fa-stack-2x"></i>
